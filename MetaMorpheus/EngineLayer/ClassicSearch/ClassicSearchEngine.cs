...
namespace EngineLayer.ClassicSearch
{
    public class ClassicSearchEngine : MetaMorpheusEngine
    {
        ...
        private readonly ConcurrentDictionary<string, double> SequenceToScoreDict;
        ...
        public ClassicSearchEngine(PeptideSpectralMatch[] globalPsms, Ms2ScanWithSpecificMass[] arrayOfSortedMS2Scans,
            ...
            ConcurrentDictionary<string, double> sequenceToScoreDict, List<string> nestedIds, bool writeSpectralLibrary)
            : base(commonParameters, fileSpecificParameters, nestedIds)
        {
            ...
            SequenceToScoreDict = sequenceToScoreDict ?? new ConcurrentDictionary<string, double>();
            ...
            // TODO: Add toggle for generating decoys
        }
        ...
        private void AddPeptideCandidateToPsm(ScanWithIndexAndNotchInfo scan, object[] myLocks, double thisScore, PeptideWithSetModifications peptide, List<MatchedFragmentIon> matchedIons)
        {
            ...
            SequenceToScoreDict.AddOrUpdate(
                key: peptide.FullSequence,
                addValueFactory: key => thisScore,
                updateValueFactory: (key, oldValue) => thisScore > oldValue ? thisScore : oldValue);
